...
# Streamlit UI Setup
st.set_page_config(page_title="HealthMind AI", layout="wide")
...
# Main Chat UI
st.title("🧠 HealthMind AI - Your Mental & Dietary Support Bot")
...
if user_input:
    ...
    if response.status_code == 200:
        ...
        bot_reply = "Error: Failed to reach the HealthMind API."
